...
def vis_from_list(list):
    ...
    o3d.visualization.draw_geometries([pcd], window_name="ctz",
                                      ...
                                      left=50, top=50,
                                      mesh_show_back_face=False)
if __name__ == '__main__': #(相较于V3墙壁没用生成点云代替 V1的代码优化版 )
    start = time.time()
    ...
    for wall_data in wall_datas:
        ...
        wall_data_clean.append(temp0), wall_data_normals.append(normal), thickness.append(thickness_temp), height.append(height_temp)
