...
def main():
    start = time.time()
    input_path = r'D:\ctz\code\PC_I\PCD2BIM_paper_lantop\wall_window_door_floor\data_对齐\wall'
    points_save_path = r'D:\ctz\code\PC_I\PCD2BIM_paper_lantop\wall_window_door_floor\data_对齐\wall'
